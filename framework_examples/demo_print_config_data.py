#
# Core APRS Client
# Prints the configuration file's config data to the console
#
...
if __name__ == "__main__":
    ...
    # print the configuration file's content to the console
    # Note: the returned object is immutable - any attempt to
