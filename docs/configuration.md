...
| [network_config](configuration_subsections/config_network.md) | [APRS-IS](https://aprs-is.net/) networking settings, such as server, port, passcode, and [APRS-IS](https://aprs-is.net/) filter |
